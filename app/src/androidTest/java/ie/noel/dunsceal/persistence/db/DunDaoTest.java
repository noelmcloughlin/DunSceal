...
public class DunDaoTest {
    ...
    public void getDunsAfterInserted() throws InterruptedException {
        ...
        assertThat(duns.size(), Matchers.is(TestData.DUNS.size()));
    }
    ...
    public void getDunById() throws InterruptedException {
        ...
        DunEntity dun = LiveDataTestUtil.getValue(mDunDao.loadDun
                (TestData.DUN_ENTITY.getId()));

        assertThat(dun.getId(), is(TestData.DUN_ENTITY.getId()));
        assertThat(dun.getName(), is(TestData.DUN_ENTITY.getName()));
        assertThat(dun.getDescription(), is(TestData.DUN_ENTITY.getDescription()));
        assertThat(dun.getPrice(), is(TestData.DUN_ENTITY.getPrice()));
    }
