...
class LoginActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.textViewLinkRegister -> {
                ...
                val intentRegister = Intent(applicationContext, org.noel.dunsceal.activities.RegisterActivity::class.java)
    ...
    private fun verifyFromSQLite() {
        ...
        if (databaseHelper!!.checkUser(textInputEditTextEmail!!.text.toString().trim { it <= ' ' }, textInputEditTextPassword!!.text.toString().trim { it <= ' ' })) {
            ...
            val accountsIntent = Intent(activity, org.noel.dunsceal.activities.UsersListActivity::class.java)
