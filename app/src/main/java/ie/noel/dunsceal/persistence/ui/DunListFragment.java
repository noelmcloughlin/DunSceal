...
public class DunListFragment extends Fragment {
    ...
    private DunAdapter mDunAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mDunAdapter = new DunAdapter(mDunClickCallback);
        mBinding.dunsList.setAdapter(mDunAdapter);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mBinding.dunsSearchBtn.setOnClickListener(new OnClickListener() {
            @Override
    ...
    private void subscribeUi(LiveData<List<DunEntity>> liveData) {
        ...
        liveData.observe(getViewLifecycleOwner(), new Observer<List<DunEntity>>() {
            @Override
    ...
    private final DunClickCallback mDunClickCallback = new DunClickCallback() {
        @Override
        public void onClick(Dun dun) {

            if (getLifecycle().getCurrentState().isAtLeast(Lifecycle.State.STARTED)) {
                ((SearchActivity) getActivity()).show(dun);
            }
        }
    };
}
