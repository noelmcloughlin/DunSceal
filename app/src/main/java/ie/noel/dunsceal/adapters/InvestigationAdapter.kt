...
import ie.noel.dunsceal.databinding.DunInvestigationCardBinding
import ie.noel.dunsceal.models.Investigation
import ie.noel.dunsceal.models.entity.InvestigationEntity
import ie.noel.dunsceal.ui.InvestigationClickCallback
...
class InvestigationAdapter(private val mInvestigationClickCallback: InvestigationClickCallback?) : RecyclerView.Adapter<InvestigationAdapter.InvestigationViewHolder>() {
  ...
  override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): InvestigationViewHolder {
    val binding = DataBindingUtil
        .inflate<DunInvestigationCardBinding>(LayoutInflater.from(parent.context), R.layout.dun_investigation_card,
            parent, false)
  ...
  class InvestigationViewHolder(val binding: DunInvestigationCardBinding) : RecyclerView.ViewHolder(binding.root)
